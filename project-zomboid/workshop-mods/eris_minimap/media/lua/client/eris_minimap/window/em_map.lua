...
em_map.vanilla_areas["Louisville"]				= {font = medium,	x1 = 13170,	y1 = 2480,	x2 = 13180,	y2 = 2490,	r = 0, g = 0, b = 0, a = 0};
...
em_map.vanilla_areas["Cafe d'Eris"]				= {font = small,	x1 = 13530,	y1 = 2130,	x2 = 13530,	y2 = 2130,	r = 0, g = 0, b = 0, a = 0};
em_map.vanilla_areas["Expo Center"]				= {font = small,	x1 = 13000,	y1 = 1290,	x2 = 13000,	y2 = 1290,	r = 0, g = 0, b = 0, a = 0};
em_map.vanilla_areas["Fossoil Field"]			= {font = small,	x1 = 13000,	y1 = 1555,	x2 = 13000,	y2 = 1555,	r = 0, g = 0, b = 0, a = 0};
em_map.vanilla_areas["Grand Ohio Mall"]			= {font = small,	x1 = 13570,	y1 = 1333,	x2 = 13570,	y2 = 1333,	r = 0, g = 0, b = 0, a = 0};
...
function em_map:updateMapOffset()
	...
	if em_core.WORLDMAP and em_core.minimap.worldMap then
		em_core.minimap.worldMap.mapAPI:centerOn(self.vpCenterXInWorld, self.vpCenterYInWorld);
	end;
end
...
function em_map:updateTransparency()
	self.mapTint.a = math.max(em_settings.map_settings.transparencyLevel, 0.33);
end
...
function em_map:updateTransforms()
	...
	if em_settings.map_settings.viewMode > 1 then
		self.transforms.scale = self.gridObj.scale(em_settings.map_settings.zoomLevel * (1.32 + 0.05) * em_core.tileRatio, em_settings.map_settings.zoomLevel * (0.66 + 0.03) * em_core.tileRatio);
		...
		self.transforms.scale = self.gridObj.scale(em_settings.map_settings.zoomLevel / em_core.tileRatio, em_settings.map_settings.zoomLevel / em_core.tileRatio);
...
function em_map:update()
	...
	--if em_core.WORLDMAP then return; end;
