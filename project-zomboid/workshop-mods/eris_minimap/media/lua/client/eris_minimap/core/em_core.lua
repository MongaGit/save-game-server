...
em_translationData = {
	...
	--worldmap options
	label_showTileMap = "Show Tile Map",
	label_showWorldMap = "Show World Map",
	label_BlurUnvisited = "Blur Unvisited Areas",
	label_DebugInfo = "Show Debug Info",
	label_CellGrid = "Show Cell Grid",
	label_TileGrid = "Show Tile Grid",
	label_UnvisitedGrid = "Show Grid On Unvisited Areas",
	label_Features = "Show Map Features",
	label_ForestZones = "Show Forest Zones",
	label_HideUnvisited = "Hide Unvisited Areas",
	label_HitTest = "Show Hit Test Info",
	label_ImagePyramid = "Show Full Color Map",
	label_LineString = "Show Line String",
	label_Players = "Show Players",
	label_Symbols = "Show Map Symbols",
	label_Wireframe = "Show Wireframe",
	label_WorldBounds = "Show World Boundaries",
	label_MiniMapSymbols = "Show Minimap Symbols",
	label_VisibleCells = "Show Visible Cells",
	label_radarMode = "CHEAT: See Everything",
};
...
em_core = {
	...
	IWBUMS = true,
	WORLDMAP = (getCore():getGameVersion() and getCore():getGameVersion():getMajor() >= 41 and getCore():getGameVersion():getMinor() >= 60) or false,
	serverMode = isServer() or false;
	clientMode = isClient() or false;
	adminMode = isAdmin() or false;
	debugMode = getDebug() or false;
	window = nil,
	minimap = nil,
	map = nil,
...
em_core.initPluginSettings = function()
	...
	if (em_core.adminMode and em_core.clientMode) then
