...
function em_mapIconMetaGroup:initialise()
	...
	local renderOrder = {
		{ID = "areaIconGroup", group = mapIconGroups.areaIconGroup},
		{ID = "safehouseGroup", group = mapIconGroups.safehouseGroup},
		{ID = "cellObjectGroup", group = mapIconGroups.cellObjectGroup},
		{ID = "customMarkerGroup", group = mapIconGroups.customMarkerGroup},
		{ID = "localPlayerGroup", group = mapIconGroups.localPlayerGroup},
		--{ID = "worldObjectsGroup", group = mapIconGroups.worldObjectsGroup},
		--{ID = "radioPingGroup", group = mapIconGroups.radioPingGroup},
	};
