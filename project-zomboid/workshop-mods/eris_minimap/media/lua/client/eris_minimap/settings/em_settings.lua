...
em_settings = {
	...
	context_settings = {
		...
		showTileMap 				= {enabled = true, option = em_translationData.label_showTileMap},
		showWorldMap 				= {enabled = false, option = em_translationData.label_showWorldMap},
		radarMode 					= {enabled = false, option = em_translationData.label_radarMode},
	...
	worldmap_settings = {
		Players 					= {enabled = true, option = em_translationData.label_Players},
		ImagePyramid 				= {enabled = true, option = em_translationData.label_ImagePyramid},
		HideUnvisited 				= {enabled = true, option = em_translationData.label_HideUnvisited},
		BlurUnvisited 				= {enabled = true, option = em_translationData.label_BlurUnvisited},
		UnvisitedGrid 				= {enabled = false, option = em_translationData.label_UnvisitedGrid},
		Symbols 					= {enabled = true, option = em_translationData.label_Symbols},
		MiniMapSymbols 				= {enabled = true, option = em_translationData.label_MiniMapSymbols},
		Features 					= {enabled = false, option = em_translationData.label_Features},
		ForestZones 				= {enabled = false, option = em_translationData.label_ForestZones},
		HitTest 					= {enabled = false, option = em_translationData.label_HitTest},
		LineString 					= {enabled = false, option = em_translationData.label_LineString},
		DebugInfo 					= {enabled = false, option = em_translationData.label_DebugInfo},
		CellGrid 					= {enabled = false, option = em_translationData.label_CellGrid},
		TileGrid 					= {enabled = false, option = em_translationData.label_TileGrid},
		WorldBounds 				= {enabled = false, option = em_translationData.label_WorldBounds},
		VisibleCells 				= {enabled = false, option = em_translationData.label_VisibleCells},
		Wireframe 					= {enabled = false, option = em_translationData.label_Wireframe},
	},
	...
	if not fileReaderObj:readLine() then
		...
		for i = 1, #fileData do
			...
			if #fileDataExp == 2 then
				...
				elseif self.worldmap_settings[fileDataExp[1]] ~= nil then
					if fileDataExp[2] == "true" then
						fileDataExp[2] = true;
					elseif fileDataExp[2] == "false" then
						fileDataExp[2] = false;
					end;
					self.worldmap_settings[fileDataExp[1]].enabled = fileDataExp[2];
...
function em_settings:save_minimap_settings()
	...
	for setting, value in pairs(self.worldmap_settings) do
		fileWriterObj:write(setting .. "=" .. tostring(value.enabled) .. "\r\n");
	end;
